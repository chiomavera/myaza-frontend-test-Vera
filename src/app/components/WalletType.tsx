...
function WalletType({ walletType, balance, imageUrl }: WalletTypeProps) {
  return (
    <div className="flex w-[282px] h-20  gap-2 p-4  items-center rounded-lg border border- [#8477FF]">
         <Image src={imageUrl} alt="A country flag of the currency in use" width={40} height={40} />
